...
const newsData = [
  {
    ...
    description: 'Важная новость для студентов! Общежитие, в котором проживают многие студенты, наконец-то претерпит капитальный ремонт. Это долгожданное решение было принято с целью улучшения условий проживания и создания комфортной обстановки для студентов. В рамках ремонта планируется обновление систем отопления, водоснабжения и электроснабжения, а также ремонт и обновление комнат, общих зон и санитарных узлов. Это позволит студентам наслаждаться уютными и современными условиями проживания, что положительно скажется на их обучении и общей жизни в учебном заведении.',
    image: HollImage,
  },
  {
    id: 2,
    title: 'Чудеса случаются',
    description: 'В рамках нового образовательного проекта, правительство объявило о значительном увеличении стипендий для студентов. Это решение было принято с целью поддержки молодежи в период экономического кризиса и стимулирования их академического развития. Увеличение стипендии позволит студентам сосредоточиться на учебе, не отвлекаясь на поиск дополнительных источников дохода.',
    image: UpMoneyImage,
  },
  {
    id: 3,
  ...
  },
  {
    ...
    description: 'Университет запускает серию онлайн-курсов, которые позволят студентам самостоятельно изучать различные предметы и развивать свои навыки. Курсы будут доступны бесплатно и предложат широкий выбор тем, от программирования до искусства и дизайна.',
